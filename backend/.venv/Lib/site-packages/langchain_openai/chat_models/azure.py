...
class AzureChatOpenAI(BaseChatOpenAI):
    ...
    Setup:
        ...
        ``AZURE_REDACTED`` and ``AZURE_OPENAI_ENDPOINT``:

        .. code-block:: bash

            pip install -U langchain-openai

            export AZURE_REDACTED="your-api-key"
