...
class BaseOpenAI(BaseLLM):
    ...
    """Automatically inferred from env var `REDACTED` if not provided."""
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        values["openai_api_key"] = get_from_dict_or_env(
            values, "openai_api_key", "REDACTED"
        )
...
class OpenAI(BaseOpenAI):
    ...
    environment variable ``REDACTED`` set with your API key.
...
class AzureOpenAI(BaseOpenAI):
    ...
    """Automatically inferred from env var `AZURE_REDACTED` if not provided."""
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        # TODO: Remove REDACTED support to avoid possible conflict when using
        # other forms of azure credentials.
        values["openai_api_key"] = (
            values["openai_api_key"]
            or os.getenv("AZURE_REDACTED")
            or os.getenv("REDACTED")
        )
