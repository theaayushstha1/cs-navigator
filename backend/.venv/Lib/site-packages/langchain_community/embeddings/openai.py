...
class OpenAIEmbeddings(BaseModel, Embeddings):
    ...
    environment variable ``REDACTED`` set with your API key or pass it
    ...
    the OPENAI_API_TYPE, OPENAI_API_BASE, REDACTED and OPENAI_API_VERSION.
    ...
    Example:
        .. code-block:: python
            ...
            os.environ["REDACTED"] = "your AzureOpenAI key"
