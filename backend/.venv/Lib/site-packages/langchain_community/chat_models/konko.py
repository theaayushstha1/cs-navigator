...
class ChatKonko(ChatOpenAI):
    ...
    environment variable ``KONKO_API_KEY`` and ``REDACTED`` set with your API key.
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"konko_api_key": "KONKO_API_KEY", "openai_api_key": "REDACTED"}
    ...
    def get_available_models(
        ...
        if not openai_api_key:
            try:
                openai_api_key = convert_to_secret_str(os.environ["REDACTED"])
            except KeyError:
